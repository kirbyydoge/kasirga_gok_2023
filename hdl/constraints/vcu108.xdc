...
set_property -dict {LOC BA10 IOSTANDARD LVCMOS18 SLEW SLOW DRIVE 8} [get_ports {uart_rx_i}]
...
set_property -dict {LOC BC24 IOSTANDARD LVCMOS18} [get_ports program_rx_i]
